    ...
    <main className="min-h-screen bg-black text-white">
      ...
      {isConfirmed && confirmedOrder ? (
        <div className="mx-auto max-w-3xl px-6 py-14">
          <section className="rounded-3xl border border-neutral-800 bg-neutral-950 p-8 sm:p-10">
            ...
            <div className="mt-6 grid gap-5 md:grid-cols-2">
              ...
              <div className="rounded-2xl border border-neutral-800 bg-neutral-900 p-5">
                ...
                <p className="mt-2 text-lg font-bold">
                  {confirmedOrder.itemCount} item
                  {confirmedOrder.itemCount !== 1
                    ? "s"
                    : ""}
                </p>
              ...
              <div className="flex gap-3">
                ...
                <div>
                  ...
                  <p className="mt-1 text-sm leading-6 text-neutral-400">
                    ...
                    and no real purchase or delivery
            ...
            <button
              type="button"
              onClick={() => router.push("/")}
              className="mt-7 flex w-full items-center justify-center gap-2 rounded-2xl bg-green-500 py-4 text-lg font-bold text-black transition hover:bg-green-600"
            >
              <ShoppingBag size={20} />
              Back to Home
            </button>
              ...
              <>
                ...
                <div className="space-y-5">
                    ...
                    <div className="flex gap-3">
                      ...
                      <div>
                        ...
                        <p className="mt-1 text-sm leading-6 text-neutral-400">
                          ...
                          checkout. No real payment or
                          purchase is being submitted.
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <button
                    ...
                    className="w-full rounded-2xl bg-green-500 py-4 text-lg font-bold text-black transition hover:bg-green-600"
                  >
                    Confirm Demo Order
                  </button>
